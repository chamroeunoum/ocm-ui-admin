        ...
        <n-card class="w-4/5 font-pvh text-xl flex">
          ...
          <div class="w-full flex flex-wrap" >
            <div class="w-1/3 p-2 mx-auto mb-6" >
              <n-input type="text" v-model:value="peopleSearch" @keyup.enter="getPeople" class="text-xs" placeholder="ស្វែងរក..." />
            </div>
            <div class="flex justify-center flex-wrap w-full" >
              <div v-for="(person,index) in people" :key="index" class="p-2" @click="toggleAssignee(person)" >
                <div class="p-2 border border-gray-200 rounded-lg w-60 cursor-pointer hover:bg-gray-100 duration-300 relative" >
                  <div class="w-32 h-32 bg-cover bg-no-repeat rounded-full mx-auto my-4 bg-center " :style=" ' background-image: url('+person.image+'); '" ></div>
