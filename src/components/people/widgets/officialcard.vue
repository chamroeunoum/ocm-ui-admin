              ...
              <table class="w-full " >
                ...
                <tr >
                  <td style="width: 2.8cm; vertical-align: middle;" >
                    ...
                    >
                      {{ record.organizationPeople[0].organization.code != "" && record.organizationPeople[0].organization.code != undefined && record.organizationPeople[0].organization.code.length > 0 ? record.organizationPeople[0].organization.code : 'OCM' }}{{ record.organizationPeople[0].code != "" && record.organizationPeople[0].code != undefined && record.organizationPeople[0].code.length > 0 ? "-" + record.organizationPeople[0].code : '-' + record.id }}
                    </div>
                  </td>
                  <td style="width: 5.7cm; padding: 0.2cm; vertical-align: top;" colspan="2" >
                    <table style="width: 6cm;">
                      ...
                      <tr>
                        ...
                        <td class="leading-4"  >០១ មករា ២០២៤</td>
                      </tr>
                      <tr>
                        <td class="text-left font-moul align-top" style="width: 2cm; "  >អសយដ្ឋាន</td>
                        <td class="leading-4">ទីស្ដីការគណៈរដ្ឋមន្ត្រី</td>
                      </tr>
                      <tr>
                        <td class="text-left font-moul align-top" style="width: 2cm; "  >អង្គភាព</td>
                        <td class="leading-4">{{ record.organizations.map( (o) => o.name ).join( ', ' )}}</td>
                      </tr>
                      <tr>
                ...
                <tr>
                  ...
                  <td style="width: 2cm; "><qrcode-vue :value="record.id+''" :size="50" level="H" class="mx-auto border border-gray-400 rounded " :render-as="'svg'" style="padding: 2px; " /></td>
                  <td style="width: 3.5cm; text-align: center; vertical-align: top; " >
                    <div class="-mt-2" >រាជធានីភ្នំពេញ ថ្ងៃទី{{ "០១" }} ខែ{{ "មករា" }} ឆ្នាំ{{ "២០២៣" }}<br/>ទីស្ដីការគណៈរដ្ឋមន្ត្រី</div>
                    <div class="-mt-4 rounded-full border border-red-300 mx-auto mr-6" style="width: 1.4cm; height: 1.4cm; padding: 0.1cm; " >
                      <div class="rounded-full border border-red-300 mx-auto" style="width: 100%; height: 100%;" >
                        <svg style="width: 90%; height: 90%; " class="text-red-500 mx-auto" 
                          xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" 
                          width="414.656" height="268.0673" 
                          viewBox="0 0 109.7111 70.9261"><g transform="matrix(.4233 0 0 .4233 -27.846 -233.7617)" 
                          fill="#fff" 
                          stroke="#FF0000" 
