        ...
        <div v-if="toggleDashboardWidgets" >
            ...
            <div class="flex flex-wrap justify-center p-4 text-md">
                ...
                <div @click="$router.push('/regulator')" class="widget-thumbnail-tln hover:scale-105 transform-gpu duration-300">
                    ...
                    <div class="m-auto mb-2 font-bold text-blue-600" v-html=" $toKhmer( totalRegulators )" ></div>
                </div>
                <div v-if="isBackendManagement()" @click="$router.push('/user')" class="widget-thumbnail-tln hover:scale-105 transform-gpu duration-300">
                    ...
                    <div class="m-auto mb-2 font-bold text-blue-600" v-html="$toKhmer( totalAccounts )" ></div>
                </div>
                <div v-if="isBackendManagement()" @click="$router.push('/officer')" class="widget-thumbnail-tln hover:scale-105 transform-gpu duration-300">
                    ...
                    <div class="m-auto mb-2 font-bold text-blue-600" v-html="$toKhmer( totalPeople )" ></div>
                </div>
            </div>
        </div>
    </Transition>
