  ...
  <!-- Top action panel of crud -->
    ...
    <div class="vcb-table-panel relative m-8 p-8">
      <div class="pk-account-info w-full">
        <div class="flex-none w-48 h-48 rounded-full m-auto border border-gray-200 overflow-hidden ">
          ...
          <div class="profileImage w-48 h-48 flex-none mx-auto  bg-center bg-no-repeat bg-white bg-cover " :style=" 'background-image: url(' + (profilePicture!=false?profilePicture:'/src/assets/logo.svg') +');' " ></div>
        </div>
      </div>
