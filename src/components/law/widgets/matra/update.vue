            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                ...
                >
                  ...
                  <n-form-item label="អត្តន័យរបស់មាត្រា" class="w-11/12 p-1" >
                    <n-input 
                      type="textarea" 
                      v-model:value="record.meaning" 
                      :autosize="{
                        minRows: 5
                      }"
                      placeholder="អត្តន័យរបស់មាត្រា" />
                  </n-form-item>
                </n-form>
...
import { ReaderSharp } from '@vicons/ionicons5'
  ...
  setup(props){
    ...
    function getRecord(){
      if( props.id >= 0 ){
        ...
        message.warning("សូមជ្រើសរើសមាត្រាជាមុនសិន។")
      }
    }

    function update(){
      if( record.title == "" && record.meaning == "" ){
        notify.warning({
