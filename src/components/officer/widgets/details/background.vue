                                ...
                                <table v-if=" officer.people != undefined && officer.people != null " class="w-full" style="border-spacing: 0px; " >
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="" >{{ officer.code }}</td>
                                        </tr>
                                            ...
                                            <td>
                                                ...
                                                <table class="w-full" style="border-spacing: 0px; " >
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="w-48 " >ថ្ងៃខែឆ្នាំកំណើត</td>
                                                            <td>{{ officer.people.father_dob }}</td>
                                                ...
                                                <table class="w-full" style="border-spacing: 0px; " >
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="w-48 " >ថ្ងៃខែឆ្នាំកំណើត</td>
                                                            <td>{{ officer.people.mother_dob }}</td>
                                                ...
                                                <table class="w-full border border-gray-100 " style="border-spacing: 0px; " >
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( officer.unofficial_date ) }}</td>
                                                            <td class="border-b border-gray-100 p-2 " >ថ្ងៃខែឆ្នាំតាំងស៊ុប់ក្នុងក្របខ័ណ្ឌរដ្ឋ ៖ </td>
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( officer.official_date ) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="border-b border-gray-100 p-2 " >ឈ្មោះក្របខណ្ឌ ៖ </td>
                                                            <td class="border-b border-gray-100 p-2 " >ក.៣.៤.</td>
                                                            <td class="border-b border-gray-100 p-2 " >ក្របខណ្ឌ ឋានន្តរស័ក្ត និងថ្នាក់បច្ចុប្បន្ន ៖ </td>
                                                            <td class="border-b border-gray-100 p-2 " >ក.៣.២.</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                                ...
                                                <table class="w-full border border-gray-100 " style="border-spacing: 0px; " >
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(job,index) in officer.job_backgrounds.filter( (jb) => jb.sector == 0 )" :key="index" >
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( job.start ) }}</td>
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( job.end ) }}</td>
                                                ...
                                                <table class="w-full border border-gray-100 " style="border-spacing: 0px; " >
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(rank , index) in officer.ranking_by_workings " :key="index" >
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( rank.date ) }}</td>
                                                ...
                                                <table class="w-full border border-gray-100 " style="border-spacing: 0px; " >
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(work , index) in officer.pending_works.filter( (w) => w.type == 0 ) " :key="index" >
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( work.start ) }}</td>
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( work.end ) }}</td>
                                                ...
                                                <table class="w-full border border-gray-100 " style="border-spacing: 0px; " >
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(medal , index) in officer.medal_histories " :key="index" >
                                                            ...
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( medal.date ) }}</td>
                                                ...
                                                <table class="w-full border border-gray-100 " style="border-spacing: 0px; " >
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(penalty , index) in officer.panelty_histories " :key="index" >
                                                            ...
                                                            <td class="border-b border-gray-100 p-2 " >{{ $toKhmer( penalty.date ) }}</td>
