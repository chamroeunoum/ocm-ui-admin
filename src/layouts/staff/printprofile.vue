  ...
  <div class="birth-information relative flex flex-wrap mx-auto " style="width: 21cm; " >
    <div v-if="officer != undefined && officer != null " class="p-2 flex flex-wrap text-left " >
      <div class="heading w-full mb-4 relative flex flex-wrap " >
        ...
        <div class="font-tacteing w-full  text-center" style="font-size: 3rem; " >3</div>
        <div class="organization w-1/2 relative my-2 pt-6 text-left" >
          <div class="font-moul w-full leading-6" >ទីស្ដីការគណៈរដ្ឋមន្ត្រី</div>
          <div class="font-moul w-full leading-6" >{{ officer.organization.name }}</div>
        </div>
        <div class="profile-photo w-1/2 relative my-2 " style="height: 3.2cm; " >
      ...
      <div class="font-moul w-full pb-2  text-center" >ជីវប្រវត្តិមន្ត្រីរាជការ
        <div class="font-tacteing w-full mt-2 text-center" style="font-size: 2rem; " >3</div>
      </div>
      <div class="body w-full " >
              ...
              <tbody>
                    ...
                    <table class="w-full" >
                      <tbody>
                        <tr >
                          ...
                          <td>{{ officer.people.wedding_certificates[0].wedding_number }}</td>
                          <td >លេខសៀវភៅអាពាហ៍ពិពាហ៍</td>
                          <td>{{ officer.people.wedding_certificates[0].book_number }}</td>
                        </tr>
                        <tr >
                          ...
                          <td>
                              ...
                              <div class="w-40 flex leading-6 " >
                                <svg v-if="officer.people.wedding_certificates[0].spouse_death == 0" class="w-6 h-6 mr-1 text-gray-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32"><path d="M26 4H6a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM6 26V6h20v20z" fill="currentColor"></path><path d="M14 21.5l-5-4.96L10.59 15L14 18.35L21.41 11L23 12.58l-9 8.92z" fill="currentColor"></path></svg>
                                <svg v-if="officer.people.wedding_certificates[0].spouse_death != 0" class="w-6 h-6 mr-1 text-gray-400" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></rect></svg>
                                រស់
                              </div>
                          </td>
                          <td>
                              ...
                              <div class="w-40 flex leading-6 " >
                                <svg v-if="officer.people.wedding_certificates[0].spouse_death == 1" class="w-6 h-6 mr-1 text-gray-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32"><path d="M26 4H6a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zM6 26V6h20v20z" fill="currentColor"></path><path d="M14 21.5l-5-4.96L10.59 15L14 18.35L21.41 11L23 12.58l-9 8.92z" fill="currentColor"></path></svg>
                                <svg v-if="officer.people.wedding_certificates[0].spouse_death != 1" class="w-6 h-6 mr-1 text-gray-400" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></rect></svg>
                                រស់
                              </div>
                          </td>
                        </tr>
                        ...
                        <tr >
                          ...
                          <td>{{ $toKhmer( dateFormat( new Date( officer.people.wedding_certificates[0].spouse_dob ) , 'dd-mm-yyyy' ) ) }}</td>
                        </tr>
                        <tr >
                          <td class="w-48 ">អត្តសញ្ញាណប័ណ្ណសញ្ជាតិខ្មែរ</td>
                          <td>{{ officer.people.wedding_certificates[0].spouse_nid }}</td>
                        </tr>
                        <tr >
                ...
                <tr>
                  <td>
                    ...
                    <table v-if=" officer.people.wedding_certificates[0].birth_certificates != undefined && officer.people.wedding_certificates[0].birth_certificates != null && officer.people.wedding_certificates[0].birth_certificates.length > 0 " class="w-full" >
                      <tbody>
                        <tr >
                  ...
                  <td>
                    ...
                    <table class="w-full" >
                      <tbody>
                        ...
                        <tr>
                          <td >ថ្ងៃខែឆ្នាំកំណើត</td>
                          <td>{{ $toKhmer( dateFormat( new Date( officer.people.father_dob ) , 'dd-mm-yyyy' ) ) }}</td>
                    ...
                    <table class="w-full" >
                      <tbody>
                        ...
                        <tr>
                          <td >ថ្ងៃខែឆ្នាំកំណើត</td>
                          <td>{{ $toKhmer( dateFormat( new Date( officer.people.mother_dob ) , 'dd-mm-yyyy' ) ) }}</td>
        ...
        <div class="form-panel     w-full mx-auto " >
          <div class="w-full " >
            <div class="relative w-full my-2 font-btb-black " >គ- ព័ត៌មានទំនាក់ទំនងក្នុងករណីមានអាសន្ន</div>
            <table class="w-full" >
              <tbody>
                <tr>
                ...
                <tr>
                  <td >លេខទូរសព្ទ ៖ </td>
                  <td >{{ officer.people.emergency_phone }}</td>
                  <td >អ៉ីមែល ៖ </td>
        ...
        <div class="form-panel     w-full mx-auto " >
          <div class="w-full " >
            <div class="relative w-full my-2 font-btb-black " >ឃ- កំរិតវប្បធម៌ទូទៅ ការបណ្ដុះបណ្ដាលមុខវិជ្ជាជីវៈ និងការបណ្ដុះបណ្ដាលបន្ត</div>
            <table class="w-full" >
              <tbody>
                <tr>
                  <td>
        ...
        <div class="form-panel     w-full mx-auto " >
          <div class="w-full " >
            <div class="relative w-full my-4 font-btb-black " >ង- ភាសាបរទេស (សូមបំពេញនូវកម្រិតចំណេះដឹងភាសាបរទេស ពីល្អ មធ្យម ខ្សោយ)</div>
        ...
        <div class="form-panel     w-full mx-auto " >
          <div class="w-full " >
            <div class="relative w-full mt-4 mb-2 font-btb-black " >ច- ប្រវត្តិការងារ</div>
            <table class="w-full" >  
              <tbody>
                <tr>
                  <td>
                    <table class="w-full " >
                      <tbody>
                        <tr>
                          ...
                          <td class="" >{{ $toKhmer( dateFormat( new Date( officer.unofficial_date ) , 'dd-mm-yyyy' ) ) }}</td>
                          <td class="" >ថ្ងៃខែឆ្នាំតាំងស៊ុប់ក្នុងក្របខ័ណ្ឌរដ្ឋ ៖ </td>
                          <td class="" >{{ $toKhmer( dateFormat( new Date( officer.official_date) , 'dd-mm-yyyy' ) ) }}</td>
                        </tr>
                        <tr>
                          <td class="" >- ឈ្មោះក្របខណ្ឌ ៖ </td>
                          <td class="" >រដ្ឋបាលទូទៅ</td>
      ...
      <!-- Reward & Penalty -->
        <div class="form-panel     w-full mx-auto mt-4" >
          <div class="w-full " >
            <div class="relative w-full pb-2 font-btb-black " >ឆ-ការលើកសរសើរ ឬដាក់វិន័យ</div>
            <table class="w-full"  >  
              <tbody>
                <tr>
                  <td>
        ...
        <div class="w-full relative h-60" >
          <div class="absolute left-0 top-0 w-80" >
            ...
            <p class="text-center leading-6 " >ថ្ងៃ {{ $getKhDay() }}  ខែ {{ $getKhMonth() }} ឆ្នាំ {{ $toKhmer( today.getFullYear() ) }}     </p>
          ...
          <div class="absolute right-0 top-0 w-80" >
            ...
            <p class="text-center leading-6 " >ថ្ងៃ {{ $getKhDay() }}  ខែ {{ $getKhMonth() }} ឆ្នាំ {{ $toKhmer( today.getFullYear() ) }}     </p>
            <p class="text-center leading-6 " >រាជធានីភ្នំពេញ ថ្ងៃទី{{ $getKhDay() }}  ខែ{{ $getKhMonth() }} ឆ្នាំ{{ $toKhmer( today.getFullYear() ) }}</p>
            <p class="text-center mt-28" ><span class="font-moul" >{{ ( officer.countesy != undefined && officer.countesy != null ? officer.countesy.name + ' ' : '' ) + officer.people.lastname + ' ' + officer.people.firstname }}</span></p>
          </div>
        </div>
      </div>
    </div>
